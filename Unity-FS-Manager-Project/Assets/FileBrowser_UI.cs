...
public class FileBrowser_UI : MonoBehaviour
{
    ...
    IEnumerator WaitForResult()
    {
        ...
        t = FileBrowser_UI.Instance._sResult;
        videoInfo.moviePath = t;
    ...
    public void readtxt()
    {
        ...
        string value1 = File.ReadAllText(_tCurrentlySelected.ToString());
    ...
    public void HideWindows(string sReturnValue)
    {
        _sResult = sReturnValue;
        _bIsOpen = false;
        _tRoot.SetActive(false);
    ...
    public void PlayMovie()
    {
        ...
        videoInfo.moviePath = t;
        VideoPlayer.SetAsLastSibling();
        // HideWindows(_tCurrentlySelected._sPath);
        fs.SetActive(false);
        // string moviePath = _tCurrentlySelected._sPath;
        ...
        char selffile = System.Convert.ToChar(@"/safemode.self");

        char desfile = System.Convert.ToChar(@"/mnt/usb0/ss.self");

        decrypts(selffile, desfile);
