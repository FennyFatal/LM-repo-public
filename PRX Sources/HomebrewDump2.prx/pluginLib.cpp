...
int Sys::shutdown() { return syscall(621); }
int Sys::getlogin() { return syscall(49); }
int Sys::sandboxpath() { return syscall(592); }
...
//nt Sys::readlink(const char *path, char *buf, int bufsiz) { return syscall(58, path, buf, bufsiz); }
